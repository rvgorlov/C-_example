...
2. <b>thread-barrier</b> - содержит пример работы с многопоточными программами. К примеру, если нужно реализовать отсутствующие в с++11 барьеры. (https://habrahabr.ru/post/246947/) ВНИМАНИЕ: барьер срабатывает один раз. 
